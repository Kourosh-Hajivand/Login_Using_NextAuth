        ...
        {session ? (
          <div>
            <div className="flex items-center justify-center">
              ...
              />
              <h1 className="text-2xl mx-6">{session.user.name}</h1>
            </div>
          ...
          <div className="w-full max-w-[500px] h-full bg-white rounded shadow-lg p-5">
            ...
            <div className="flex flex-col space-y-2 my-6">
              <button
                ...
                className="w-full p-3 py-4 bg-blue-500 rounded flex items-center relative hover:bg-blue-600 hover:shadow duration-150"
              >
              ...
              <button
                ...
                className="w-full p-3 py-4 bg-white border-2 rounded flex items-center relative hover:bg-neutral-50 hover:shadow duration-150"
              >
                <div className="absolute top-1/2 left-10 transform  -translate-y-1/2">
                  <div className="w-8 h-8 relative">
                    <Image
